...
**** Code clarity
     ...
     - The flow of the program is split into meaningful
       programmer-defined functions called by ~main()~.
     - The operation of programmer-defined functions is explained in
       comments.
...
**** Code clarity
     ...
     - If necessary, classes are defined for program-specific data
       types.
** Example
*** Specification
    - The program
